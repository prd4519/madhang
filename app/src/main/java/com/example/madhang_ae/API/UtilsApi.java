...
public class UtilsApi {
    ...
    public static final String BASE_URL = "http://172.23.200.144/Madhang_ae/";
    public static final String IMAGE_URL = "http://172.23.200.144/Madhang_ae/assets/files/image/";
